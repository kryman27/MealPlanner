...
namespace MealPlannerAPI.Migrations
{
    ...
    [Migration("20240306093659_UserDataUpdate4")]
    partial class UserDataUpdate4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelsLib.Model.Meal", b =>
                {
                    b.Property<int>("MealId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("Relational:JsonPropertyName", "mealId");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MealId"));

                    b.Property<DateTime?>("MealDate")
                        .HasColumnType("datetime2")
                        .HasAnnotation("Relational:JsonPropertyName", "mealDate");

                    b.Property<string>("MealName")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasAnnotation("Relational:JsonPropertyName", "mealName");
            ...
            modelBuilder.Entity("ModelsLib.Model.MealDetail", b =>
                {
                    ...
                    b.HasAnnotation("Relational:JsonPropertyName", "mealDetails");
                });

            modelBuilder.Entity("ModelsLib.Model.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal?>("Fat")
                        .HasColumnType("decimal(18, 2)")
                        .HasAnnotation("Relational:JsonPropertyName", "fat");
            ...
            modelBuilder.Entity("ModelsLib.Model.UserData", b =>
                {
            ...
            modelBuilder.Entity("ModelsLib.Model.UserPreference", b =>
                {
            ...
            modelBuilder.Entity("ModelsLib.Model.MealDetail", b =>
                {
                    b.HasOne("ModelsLib.Model.Meal", null)
                        .WithMany("MealDetails")
                        .HasForeignKey("MealId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ModelsLib.Model.Product", "Product")
                        .WithMany()
